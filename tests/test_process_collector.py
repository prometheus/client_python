...
class TestProcessCollector(unittest.TestCase):
    ...
    def test_working(self):
        ...
        self.assertEqual(397312, self.registry.get_sample_value('process_swap_bytes'))
    ...
    def test_namespace(self):
        ...
        self.assertEqual(397312, self.registry.get_sample_value('n_process_swap_bytes'))
    ...
    def test_working_584(self):
        ...
        self.assertEqual(None, self.registry.get_sample_value('process_swap_bytes'))
